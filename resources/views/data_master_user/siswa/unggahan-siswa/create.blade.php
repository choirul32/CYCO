...
<div class="page-content">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="container-fluid">
        <form action="{{ url('siswa/unggahan-siswa/create') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">Parsley is a javascript form validation
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="nama" value="" type="text" class="form-control" required placeholder=""/>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-title-desc">Parsley is a javascript form validation
                                ...
                                <div class="file-upload" id="file">
                                    ...
                                    <input name="file_unggahan" class="file-upload-input" type='file' onchange="readURL(this);" accept="image/*,.pdf" />
                                    <div class="drag-text">
...
<script>
    $('document').ready(function(){
        if ($('#file_unggahan').find('.file-upload-image').attr('src') !== undefined) {
            $('#file_unggahan').find('.file-upload-content').show();
            $('#file_unggahan').find('.image-upload-wrap').hide();
        }
    });
